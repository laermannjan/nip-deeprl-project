...
class DQN:
    ...
    def _build_network(self, h_size=30,h2_size = 30, l_rate=1*1e-2):
    ...
    with tf.Session() as sess:
        ...
        for episode in range(max_episodes):
            ...
            while not done:
                ...
                replay_buffer.append((state, action, (reward-2), next_state, done))
            ...
            if (episode % 10 == 1) and (episode > 5): # train every 10 episode
                print ("Breaksum: ", breaksum)
                lstep = 100
                if breaksum > -1000 : lstep = 300;
                else: breaksum = 0
