...
HIDDEN_SIZES = [[30], [50], [100], [30, 30], [40, 20], [60, 60], [30, 30, 30], [40, 30, 20]] #baseline 30-30-30
...
MAX_EPISODE = 500 
STEPS_PER_EPISODE = 500 #5000 for acrobot
DIS = 0.99
TESTCOUNT = 50
...
primer = 0
for h in HIDDEN_SIZES:  ## change here
    primer += 1 
    params['hidden_size'] = h ## change here
    for i in range(10):
